...
namespace AbpBookStore.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpBookStoreDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpBookStoreEfCoreEntityExtensionMappings to extend the IdentityUser entity
